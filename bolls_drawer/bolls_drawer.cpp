...
// bolls_drawer.cpp: определяет поведение классов для приложения.
//
...
BEGIN_MESSAGE_MAP(CbollsdrawerApp, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// Создание CbollsdrawerApp

CbollsdrawerApp::CbollsdrawerApp()
{
...
// Единственный объект CbollsdrawerApp

CbollsdrawerApp theApp;


// Инициализация CbollsdrawerApp

BOOL CbollsdrawerApp::InitInstance()
{
